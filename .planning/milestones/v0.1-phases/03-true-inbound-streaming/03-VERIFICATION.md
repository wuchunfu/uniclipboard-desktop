...
| 3   | `ProtocolMessage::frame_to_bytes(trailing_payload)` produces the two-segment wire format                                                      | VERIFIED | `protocol_message.rs` lines 32-45: full implementation; 3 unit tests all pass (`frame_to_bytes_roundtrip_no_trailing`, `frame_to_bytes_with_trailing_payload`, `frame_to_bytes_empty_trailing`)                          |
...
| ------------------------------------------------------------------- | ------------------------------------------------------- | -------- | ------------------------------------------------------------------ |
| `src-tauri/crates/uc-core/src/network/protocol/protocol_message.rs` | `frame_to_bytes()` method                               | VERIFIED | Lines 32-45: full implementation with doc comment; 3 unit tests    |
