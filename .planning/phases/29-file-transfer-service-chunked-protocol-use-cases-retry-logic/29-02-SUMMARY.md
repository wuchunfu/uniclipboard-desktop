...
affects: [30-file-sync-ui, 31-file-sync-settings-polish]
...
key-decisions:
  ...
  - "File transport delegation is logged-only pending Phase 29 Plan 01 chunked send wiring"
...
# Phase 29 Plan 02: File Sync Use Cases Summary
