# Phase 30: File transfer service — chunked protocol, use cases, retry logic - Context
...
- `SyncInboundFileUseCase`: Handles incoming file transfer
  ...
  - Large files (above threshold): sync metadata only, content pulled on-demand (Phase 31 UI trigger)
...
_Phase: 29 (Transfer) — split from original monolithic Phase 28_
