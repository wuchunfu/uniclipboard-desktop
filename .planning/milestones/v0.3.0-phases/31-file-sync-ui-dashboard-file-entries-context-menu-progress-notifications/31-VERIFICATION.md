...
| --------------------------- | -------- | -------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------- |
| `src/api/clipboardItems.ts` | 462, 474 | Tauri command stubs (`download_file_entry`, `open_file_location`) calling backend commands not yet implemented | ℹ️ Info  | Expected: backend implementation is Phase 30/31 concern; stubs are correct placeholder pattern for UI-first development |
