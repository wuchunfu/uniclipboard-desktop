...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 29-01-01 | 01 | 1 | FSYNC-TRANSFER | unit | `cd src-tauri && cargo test -p uc-platform --lib file_transfer` | ❌ W0 | ⬜ pending |
| 29-01-02 | 01 | 1 | FSYNC-TRANSFER | unit | `cd src-tauri && cargo test -p uc-platform --lib file_transfer::protocol` | ❌ W0 | ⬜ pending |
| 29-02-01 | 02 | 1 | FSYNC-TRANSFER | unit | `cd src-tauri && cargo test -p uc-app --lib file_sync` | ❌ W0 | ⬜ pending |
| 29-02-02 | 02 | 1 | FSYNC-TRANSFER | unit | `cd src-tauri && cargo test -p uc-app --lib file_sync::sync_outbound` | ❌ W0 | ⬜ pending |
| 29-03-01 | 03 | 2 | FSYNC-TRANSFER | unit | `cd src-tauri && cargo test -p uc-platform --lib file_transfer::queue` | ❌ W0 | ⬜ pending |
| 29-03-02 | 03 | 2 | FSYNC-TRANSFER | unit | `cd src-tauri && cargo test -p uc-platform --lib file_transfer::retry` | ❌ W0 | ⬜ pending |
