# Phase 32: File Sync Settings and Polish — Research
...
Phase 28 will extend `SyncSettings` with file sync fields. Phase 32 wires these to UI.
...
Per Phase 30 context, `SyncInboundFileUseCase` handles incoming files:

- Disk space pre-check before accepting transfer
- Per-device file-cache quota enforcement (default 500MB)

Phase 32 wires the settings value to this enforcement point:
