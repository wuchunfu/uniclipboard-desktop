...
affects: [phase-30-file-sync-ui, phase-31-file-sync-settings]
...
# Phase 29 Plan 03: Queue, Retry, and Bootstrap Wiring Summary
...
- Phase 30 can build file sync UI with Dashboard file entries, context menu, progress, and notifications
- Phase 31 can add file sync settings UI, quota enforcement, and auto-cleanup
