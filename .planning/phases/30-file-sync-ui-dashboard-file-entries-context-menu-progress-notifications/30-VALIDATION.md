...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 30-01-01 | 01 | 1 | FSYNC-UI | unit | `bun run test -- --run -t "context menu"` | ❌ W0 | ⬜ pending |
| 30-01-02 | 01 | 1 | FSYNC-UI | unit | `bun run test -- --run -t "file entry"` | ❌ W0 | ⬜ pending |
| 30-02-01 | 02 | 1 | FSYNC-UI | unit | `bun run test -- --run -t "transfer progress"` | ❌ W0 | ⬜ pending |
| 30-03-01 | 03 | 2 | FSYNC-UI | unit | `bun run test -- --run -t "notification"` | ❌ W0 | ⬜ pending |
