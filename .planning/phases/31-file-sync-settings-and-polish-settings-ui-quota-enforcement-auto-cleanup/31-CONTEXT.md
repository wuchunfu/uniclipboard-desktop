# Phase 31: File sync settings and polish — settings UI, quota enforcement, auto-cleanup - Context

**Gathered:** 2026-03-13
**Updated:** 2026-03-13 (split from monolithic Phase 28)
**Status:** Ready for planning
**Scope:** ~600-800 LoC
**Depends on:** Phase 30 (UI must be in place for settings integration)
...
- Quota check happens before accepting file transfer (in SyncInboundFileUseCase from Phase 29, but enforcement logic wired here)
...
- Phase 29 use cases: add quota check calls and file_sync_enabled guard
- Phase 30 UI: settings changes affect Dashboard file entry behavior
...
*Phase: 31 (Settings & Polish) — split from original monolithic Phase 28*
